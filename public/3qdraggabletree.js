// THIS IS AN ADVANCED EXAMPLE (USING VUE). You probably do not need to be able to do something like this
// this code is for generating the draggable tree component (used on slide 8) 
