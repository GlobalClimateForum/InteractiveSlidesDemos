...
# !!! Main.UserApp is configured as an alias for Main.MyGenieApp and you might encounter it in some tests
using Main.MyGenieApp, Test, TestSetExtensions, Logging

Logging.global_logger(NullLogger())

@testset ExtendedTestSet "DTprototype tests" begin
  @includetests ARGS
end
