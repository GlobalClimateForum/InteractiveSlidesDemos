...
#Fields for interactive slides (THESE NEED TO BE DEFINED IN THE SAME SCOPE)
#region
...
@save_on(feedback, "feedback")
@save_on(choices_table, "choices")
